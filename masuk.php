...
<div id="home">
	<div id="isi">
	<center>
		<form name="input_data" action="action_save.php" method="post">
		<table border="0" cellpadding="5" cellspacing="0">
		    <tbody>
		    	...
		    	<tr>
		        	<td>Perihal</td>
		        	<td>:</td>
		        	<td><input type="text" name="perihal" maxlength="100" required="required" /></td>
		        </tr>
		    	<tr>
		        	<td>Pengirim</td>
		        	<td>:</td>
		        	<td><input type="text" name="pengirim" maxlength="100" required="required" /></td>
		        </tr>
		    	<tr>
		        	<td>Nominal</td>
		        	<td>:</td>
		        	<td><input type="text" name="nominal" required="required" /></td>
		        </tr>
		    	<tr>
		        	<td>Tanggal</td>
		        	<td>:</td>
		        	<td><input type="text" name="tanggal" id="tanggal" required="required" /></td>
		        </tr>
		    	<tr>
	...
	<div id="isi1">
			...
			<table border="1" cellpadding="5" cellspacing="0" class="table">
			    ...
			    <?php 
					$query = mysql_query("select * from mst_masuk");
					$no = 1;
					if ($query === FALSE){
						die(mysql_error());
					}				
				...
				?>
			    	<tr>
			            ...
			            <td>
			            	<a href="edit.php?id=<?php echo $data['no_id']; ?>"><button class="btn btn-primary">Edit</button></a> || 
			                <a href="delete.php?id=<?php echo $data['no_id'];?>"><button class="btn btn-danger" onClick="return confirm('Are you sure you want to delete this?')">Delete</button></a>
			            </td>
			        </tr>
			    <?php 
					$no++;
