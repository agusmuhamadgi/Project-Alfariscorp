...
<div id="home">
    ...
    <center>
        ...
        $query = mysql_query("select * from mst_masuk where no_id='$id'") or die(mysql_error());

        $data = mysql_fetch_array($query);
        ?>

        <form name="edit" action="edit_action.php" method="post">
            ...
            <table border="1" cellpadding="5" cellspacing="0" class="table">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit.php?id=<?php echo $data['user_id']; ?>"><button class="btn btn-primary">Edit</button></a> || 
