...
<div id="home">
	<div id="isi">
	<center>
		<form name="input_data" action="action_save_ex.php" method="post">
			...
			<table border="1" cellpadding="5" cellspacing="0" class="table">
				...
				?>
			    	<tr>
			            ...
			            <td>
			            	<a href="edit_ex.php?id=<?php echo $data['no_id']; ?>"><button class="btn btn-primary">Edit</button></a> || 
			                <a href="delete_ex.php?id=<?php echo $data['no_id'];?>"><button class="btn btn-danger" onClick="return confirm('Are you sure you want to delete this?')">Delete</button></a>
			            </td>
			        </tr>
			    <?php 
					$no++;
